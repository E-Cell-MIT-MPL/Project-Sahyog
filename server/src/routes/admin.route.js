...
import { Adminlogin, Adminlogout, changeAdminPasswordAtLogin, forgotpassword, refreshaccesstoken, RegisterAdmin, resetpasswordtoken, verifytoken } from "../controllers/Admin.controller.js";
...
router.route('/login/resetpassword').post(VerifyJWT,changeAdminPasswordAtLogin);//working
